            ...
            <table className="w-full subject-table"> {/* Apply subject-table class */}
              ...
              <tbody>
                <tr className="border-b border-gray-300">
                  ...
                  <td className="py-2 px-4">Introduction to Computer Science</td>
                  <td className="py-2 px-4">3</td>
                  <td className="py-2 px-4">
                  <Link to="/editSubject" className="bg-blue-500 text-white py-1 px-2 rounded mr-2"> {/* Added hover:text-white class */}
                Edit
              </Link>
